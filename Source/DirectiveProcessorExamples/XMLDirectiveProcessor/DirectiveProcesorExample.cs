...
namespace XMLDirective
{
    public class XMLDirectiveProcessor : DirectiveProcessor
    {
        ...
        private ITextTemplatingEngineHost Host = null;
        ...
        public override void Initialize(ITextTemplatingEngineHost host)
        {
            ...
            //When the Solution opens in VS for the first time, the TemplateFile property is null.
            //When run from Run Custom Tool, the TemplateFile property is populated.
            Host = host;
        ...
        {
            if (string.Compare(directiveName, "XMLDirective", StringComparison.OrdinalIgnoreCase) == 0)
            {
                return true;
            }
        ...
        public override string[] GetReferencesForProcessingRun()
        {
            ...
            //—————————————————————–
            return new string[] { "System.Xml", this.GetType().Assembly.Location };
        }
        ...
        public override string[] GetImportsForProcessingRun()
        {
            ...
            //—————————————————————–
            return new string[] { "System.Xml", "XMLDirective" };
        }
    }
