...
namespace CoolDirective
{
    ...
    public class CoolDirectiveProcessor : DirectiveProcessor
    {
        ...
        public override string[] GetImportsForProcessingRun()
        {
            ...
            //-----------------------------------------------------------------
            //We need CoolDirective to be able to call XmlReaderHelper.ReadXml
